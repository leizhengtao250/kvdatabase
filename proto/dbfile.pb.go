...
func (ManifestChange_Operation) Descriptor() protoreflect.EnumDescriptor {
	return file_dbfile_proto_enumTypes[0].Descriptor()
}

func (ManifestChange_Operation) Type() protoreflect.EnumType {
	return &file_dbfile_proto_enumTypes[0]
}
...
func (ManifestChange_Operation) EnumDescriptor() ([]byte, []int) {
	return file_dbfile_proto_rawDescGZIP(), []int{3, 0}
}
...
func (x *KV) Reset() {
	*x = KV{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dbfile_proto_msgTypes[0]
...
func (*KV) Descriptor() ([]byte, []int) {
	return file_dbfile_proto_rawDescGZIP(), []int{0}
}
...
func (x *KVList) Reset() {
	*x = KVList{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dbfile_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*KVList) Descriptor() ([]byte, []int) {
	return file_dbfile_proto_rawDescGZIP(), []int{1}
}
...
func (x *ManifestChangeSet) Reset() {
	*x = ManifestChangeSet{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dbfile_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ManifestChangeSet) Descriptor() ([]byte, []int) {
	return file_dbfile_proto_rawDescGZIP(), []int{2}
}
...
func (x *ManifestChange) Reset() {
	*x = ManifestChange{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dbfile_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ManifestChange) Descriptor() ([]byte, []int) {
	return file_dbfile_proto_rawDescGZIP(), []int{3}
}
...
func (x *TableIndex) Reset() {
	*x = TableIndex{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dbfile_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TableIndex) Descriptor() ([]byte, []int) {
	return file_dbfile_proto_rawDescGZIP(), []int{4}
}
...
func (x *BlockOffset) Reset() {
	*x = BlockOffset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dbfile_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BlockOffset) Descriptor() ([]byte, []int) {
	return file_dbfile_proto_rawDescGZIP(), []int{5}
}
...
var File_dbfile_proto protoreflect.FileDescriptor

var file_dbfile_proto_rawDesc = []byte{
	,
	...
	,
	...
	0x6c, 0x65, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x6c, 0x65, 0x6e, 0x42, 0x0a,
	0x5a, 0x08, 0x2e, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}

var (
	file_dbfile_proto_rawDescOnce sync.Once
	file_dbfile_proto_rawDescData = file_dbfile_proto_rawDesc
)

func file_dbfile_proto_rawDescGZIP() []byte {
	file_dbfile_proto_rawDescOnce.Do(func() {
		file_dbfile_proto_rawDescData = protoimpl.X.CompressGZIP(file_dbfile_proto_rawDescData)
	})
	return file_dbfile_proto_rawDescData
}

var file_dbfile_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_dbfile_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_dbfile_proto_goTypes = []interface{}{
...
var file_dbfile_proto_depIdxs = []int32{
...
func init() { file_dbfile_proto_init() }
func file_dbfile_proto_init() {
	if File_dbfile_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_dbfile_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*KV); i {
			case 0:
				return &v.state
			case 1:
		...
		file_dbfile_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*KVList); i {
			case 0:
				return &v.state
			case 1:
		...
		file_dbfile_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dbfile_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dbfile_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dbfile_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_dbfile_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dbfile_proto_goTypes,
		DependencyIndexes: file_dbfile_proto_depIdxs,
		EnumInfos:         file_dbfile_proto_enumTypes,
		MessageInfos:      file_dbfile_proto_msgTypes,
	}.Build()
	File_dbfile_proto = out.File
	file_dbfile_proto_rawDesc = nil
	file_dbfile_proto_goTypes = nil
	file_dbfile_proto_depIdxs = nil
}
